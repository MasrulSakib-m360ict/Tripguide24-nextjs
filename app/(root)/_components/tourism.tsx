            ...
            <div className="text-center lg:text-left">
              <div className="mb-10 lg:mb-0">
                ...
                <p className="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-white">
                  Discover our eco-friendly villas, sea and hill-view towers,
                  health clubs, Thai spas, infinity swimming pools, convention
                  halls, specialty restaurants, juice bars, and shisha lounges.
                </p>
              </div>
            </div>
          </div>
