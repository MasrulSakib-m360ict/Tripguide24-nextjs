    ...
    <div className="bg-cover bg-center bg-[url('/images/pexels-austin-zhang-925030-2441844.jpg')]  relative min-h-[75vh] flex items-center">
      <Container className="relative z-10 ">
        {/* <div className="flex  items-center mb-4 mt-20">
          ...
          <div className="text-primary text-5xl font-bold hidden md:block">
        ...
        <div className=" mt-28 md:mt-16">
          ...
          >
            <TabsList className="grid h-auto w-full max-w-2xl grid-cols-2 sm:grid-cols-4 md:absolute z-10 -top-6 md:left-1/2 transform md:-translate-x-1/2 gap-2 p-2 bg-white rounded-lg shadow-md">
              {tabs.map((tab) => (
                <TabsTrigger
                  key={tab.value}
                  value={tab.value}
                  className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground flex items-center justify-center p-2 rounded-md "
                >
            ...
            <div className="relative w-full shadow-sm">
              <div className="relative h-full  rounded bg-white ">
                {activeTab === "flight" ? (
                  <SearchEngine />
                ) : activeTab === "visa" ? (
                  <VisaForm />
